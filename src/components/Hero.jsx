...
const FALLBACK = 'https://placehold.co/480x640/8B5E2C/e8c96a?text=Ingrid+Melo'
...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden gradient-hero pt-16 pb-28">
      ...
      />
      <div
        className="pointer-events-none absolute -bottom-20 -left-20 w-[400px] h-[400px] rounded-full opacity-20"
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mb-8 animate-fade-up" style={{ animationDelay: '0.25s' }}>
            <div className="flex -space-x-2">
              {['#8B5E2C', '#C9960C', '#CC6633', '#b5813a'].map((c, i) => (
                <div
                  key={i}
            ...
            <p className="text-sm" style={{ color: '#6e4720' }}>
              <span className="font-semibold" style={{ color: '#4a2e12' }}>+500 pacientes</span> já transformaram sua pele
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative rounded-[2rem] overflow-hidden shadow-2xl w-72 md:w-80 aspect-[3/4]" style={{ backgroundColor: '#f7e8cc' }}>
              ...
              <div
                ...
                style={{ background: 'linear-gradient(to top, rgba(45,28,10,0.65), transparent)' }}
              />
            </div>

            {/* Badge CRF — único local no site */}
            <div
              className="absolute -bottom-5 -left-5 rounded-2xl shadow-xl px-4 py-3 border"
              style={{ backgroundColor: '#2d1c0a', borderColor: '#6e4720' }}
            >
              <p className="text-[10px] font-semibold uppercase tracking-wider" style={{ color: '#e8c96a' }}>
                Farmacêutica · Gerenciamento de Pele
              </p>
            ...
            {/* Badge rating */}
            <div
              className="absolute -top-3 -right-3 rounded-2xl shadow-xl px-3 py-2 border text-center"
              style={{ backgroundColor: '#2d1c0a', borderColor: '#6e4720' }}
            >
              <p className="font-playfair text-lg font-bold" style={{ color: '#e8c96a' }}>4.9</p>
              <div className="flex gap-0.5 justify-center">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-3 h-3" style={{ color: '#C9960C' }} viewBox="0 0 20 20" fill="currentColor">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                  </svg>
                ))}
              </div>
              <p className="text-[9px] mt-0.5" style={{ color: '#C9960C' }}>Google</p>
            </div>
          </div>
        </div>
      </div>
