...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-brand-50 via-cream-100 to-white pt-16 pb-24">
      {/* Ornamento de fundo */}
      <div className="pointer-events-none absolute -top-32 -right-32 w-[500px] h-[500px] rounded-full bg-brand-100/40 blur-3xl" />
      <div className="pointer-events-none absolute bottom-0 -left-20 w-[300px] h-[300px] rounded-full bg-blush-100/50 blur-2xl" />
      ...
      <div className="section-wrapper relative grid gap-12 md:grid-cols-[1.1fr,1fr] items-center">
        ...
        <div>
          ...
          <p className="text-brand-400 text-lg leading-relaxed mb-8 max-w-md animate-fade-up" style={{ animationDelay: '0.15s' }}>
            Protocolos científicos e olhar estético para realçar o que há de mais belo em você—com segurança, naturalidade e cuidado personalizado.
          </p>
        ...
        <div className="flex justify-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
          <div className="relative">
            {/* Moldura decorativa */}
            <div className="absolute -inset-3 rounded-3xl bg-gradient-to-br from-brand-200 to-blush-200 opacity-40 blur-sm" />
            <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-brand-200/50 aspect-[3/4] w-72 md:w-80 bg-brand-100">
              {/*
                FOTO DA PROFISSIONAL
                -----------------------------------------------------------
                Substitua o src abaixo pela URL ou caminho da foto da Ingrid.
                Sugestão: adicione o arquivo em /public/images/ingrid.jpg
                e troque src por "/images/ingrid.jpg"
                -----------------------------------------------------------
              */}
              <img
                src="https://placehold.co/480x640/E5DEFF/7E69AB?text=Foto+Ingrid"
